    ...
    return (
      <div className="space-y-2">
        ...
        <textarea
          ...
          className={cn(
            'focus-ring min-h-[100px] w-full rounded-xl border border-border bg-white/90 px-3 py-2.5 text-sm text-primary placeholder:text-primary/35 shadow-sm outline-none resize-y',
